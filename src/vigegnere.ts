...
function decodificarVigenere(mensagemCodificada: string, chave: string): string {
...
document.addEventListener("DOMContentLoaded", function() {
    let botaoCodificar = document.getElementById("botaoCodificar") as HTMLButtonElement;
    if (botaoCodificar) {
        botaoCodificar.addEventListener("click", function() {
            // Obter os valores da mensagem e da chave
            let mensagemInput = document.getElementById("mensagem") as HTMLInputElement;
            ...
            let mensagemCodificadaInput = document.getElementById("mensagemCodificada") as HTMLInputElement;
            mensagemCodificadaInput.value = mensagemCodificada;
        });
    }

    let botaoDecodificar = document.getElementById("botaoDecodificar") as HTMLButtonElement;
    if (botaoDecodificar) {
        botaoDecodificar.addEventListener("click", function() {
            ...
            // Exibir o resultado na caixa de texto
            let mensagemDecodificadaInput = document.getElementById("mensagemDecodificada") as HTMLInputElement;
